...
const projects = [
  {
    ...
    description:
      "Aplicação PHP/MySQL focada em CRUD completo para gerenciamento de projetos acadêmicos.",
    stack: ["PHP", "MySQL"],
    ...
    image: "/project-restaurante.svg",
  },
  {
    title: "Agenda de Contatos API",
    description:
      "API RESTful em Node.js com Express, autenticação e persistência em JSON.",
    ...
    image: "/project-agenda.svg",
  },
  {
    title: "G2 Barbearia",
    description:
      "Plataforma web para gerenciamento operacional de uma barbearia, incluindo controle de serviços, agenda, clientes e fluxo interno.",
  ...
  },
  {
    ...
    description:
      "Site responsivo em React e Tailwind voltado para serviços de suporte técnico e hardware.",
    ...
    image: "/project-zelus.svg",
  },
  {
    title: "Doceria Jae",
    description:
      "Site acadêmico em React/JS desenvolvido para prática de layout e responsividade",
  ...
  },
  {
    ...
    description:
      "Fork de um projeto artístico/chocolateira com foco em experiência criativa.",
    stack: ["JavaScript"],
    code: "https://github.com/gaherrera00/dulcis.veneris",
    demo: "https://github.com/gaherrera00/dulcis.veneris",
    image: "/project-dulcis.svg",
  },
];
...
export default function App() {
  ...
  return (
    <div
      className={`min-h-screen ${gradientBg} transition-colors duration-300 dark:bg-dark dark:text-slate-100`}
    >
          ...
          >
            <div className="space-y-6">
              ...
              <p className="text-slate-300 text-lg">
                Desenvolvedor full-stack com foco em experiências simples,
                rápidas e funcionais. Busco uma oportunidade de estágio para
                crescer criando produtos que façam diferença.
              </p>
            ...
            <div className="flex flex-col gap-8 lg:flex-row lg:items-start lg:justify-between">
              <div className="max-w-2xl space-y-4">
                ...
                <p className="text-slate-300">
                  ...
                  construir experiências digitais que sejam memoráveis.
                </p>
          ...
          <section id="projects" className="space-y-6">
            <div className="flex flex-col gap-2">
              ...
              <p className="text-slate-300 max-w-3xl">
                Uma seleção dos trabalhos e estudos mais recentes que refletem
                meu foco em entregar valor rápido, com código legível e atenção
                aos detalhes de UX.
              </p>
            </div>
                  ...
                  <div className="mt-4 space-y-3">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {project.stack.map((tech) => (
                        <span
                          key={tech}
                          className="rounded-full bg-black/30 px-3 py-1 text-xs text-slate-200"
                        >
                          {tech}
                        </span>
                      ))}
          ...
          >
            <div className="grid gap-8 lg:grid-cols-2">
              <div className="space-y-4">
                ...
                <p className="text-slate-300">
                  Estou aberto para estágios, freelas e colaborações. Conte-me
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-3 rounded-2xl bg-black/30 px-4 py-3 text-sm text-slate-200">
                    <span>👨‍💻</span>
                    <a className="hover:text-secondary" href={socials.github}>
                      gaherrera00
                    </a>
                  </div>
                </div>
